...
if(event.currentTarget.classList.contains('like-button_not-active-color')){
        $(event.currentTarget.firstChild).attr("src", "./src/modules/mixin-like-button/img/favorite.png");
        ...
        $(event.currentTarget.firstChild).attr("src", "./src/modules/mixin-like-button/img/favorite_border.png");
